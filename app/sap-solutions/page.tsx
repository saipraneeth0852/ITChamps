            ...
            <div className="footer-section__links">
              ...
              <div>
                ...
                <div className="footer-social">
                  <a href="https://www.linkedin.com/company/itchamps-software-pvt-ltd/" target="_blank" rel="noreferrer" aria-label="ITChamps on LinkedIn" className="footer-social__link">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                      <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/>
                    </svg>
                    LinkedIn
                  </a>
                  <a href="https://youtube.com/@itchampssap" target="_blank" rel="noreferrer" aria-label="ITChamps on YouTube" className="footer-social__link">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  ...
                  <a href="https://x.com/ITChamps_SAP" target="_blank" rel="noreferrer" aria-label="ITChamps on X" className="footer-social__link">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622Zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                    X
                  </a>
                  <a href="https://www.instagram.com/itchamps_software_pvt_ltd" target="_blank" rel="noreferrer" aria-label="ITChamps on Instagram" className="footer-social__link">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                      <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="none" stroke="currentColor" strokeWidth="2"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" fill="none" stroke="currentColor" strokeWidth="2"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
                    Instagram
                  </a>
                  <a href="https://www.facebook.com/share/18ayvzxcU3/" target="_blank" rel="noreferrer" aria-label="ITChamps on Facebook" className="footer-social__link">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
